...
public class SavedDataMsg extends net.tinyos.message.Message {
    ...
    /** Create a new SavedDataMsg of size 27. */
    public SavedDataMsg() {
    ...
    public String toString() {
      ...
      try {
        s += "  [savedData.kdcData.counter=0x"+Long.toHexString(get_savedData_kdcData_counter())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: savedData.kdcData.counter
    //   Field type: short
    //   Offset (bits): 192
    //   Size (bits): 8
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'savedData.kdcData.counter' is signed (false).
     */
    public static boolean isSigned_savedData_kdcData_counter() {
        return false;
    }

    /**
     * Return whether the field 'savedData.kdcData.counter' is an array (false).
     */
    public static boolean isArray_savedData_kdcData_counter() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'savedData.kdcData.counter'
     */
    public static int offset_savedData_kdcData_counter() {
        return (192 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'savedData.kdcData.counter'
     */
    public static int offsetBits_savedData_kdcData_counter() {
        return 192;
    }

    /**
     * Return the value (as a short) of the field 'savedData.kdcData.counter'
     */
    public short get_savedData_kdcData_counter() {
        return (short)getUIntBEElement(offsetBits_savedData_kdcData_counter(), 8);
    }

    /**
     * Set the value of the field 'savedData.kdcData.counter'
     */
    public void set_savedData_kdcData_counter(short value) {
        setUIntBEElement(offsetBits_savedData_kdcData_counter(), 8, value);
    }

    /**
     * Return the size, in bytes, of the field 'savedData.kdcData.counter'
     */
    public static int size_savedData_kdcData_counter() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of the field 'savedData.kdcData.counter'
     */
    public static int sizeBits_savedData_kdcData_counter() {
        return 8;
    }
